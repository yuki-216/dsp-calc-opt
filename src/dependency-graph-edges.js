 ...
 * @param {Object} params
 * @param {Map<string, {recipeId: string, mainItem: string, inputs: Object}>} params.recipes - 引擎二部图 recipes(= graph.recipes)
